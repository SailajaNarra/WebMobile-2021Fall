...
public class MainActivity extends AppCompatActivity {
    ...
    private void recognition(String text){
        ...
        if(text.contains("hello")) {
            ...
            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:blue;\">User : " +text+"</p>"));
        ...
        if(text.contains("my name is"))
        {
            ...
            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:blue;\">"+name+ ": " +text+"</p>"));
        ...
        if(text.contains("not feeling well"))
        {
            ...
            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:blue;\">"+preferences.getString(NAME, null)+ ": " +text+"</p>"));
